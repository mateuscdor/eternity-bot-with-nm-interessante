module.exports={
    name:"stalk",
    alias:["stalknumber","stalker"],
    usage:"/stalk 9181011878xx",
    desc:"To search and find any incomplete WhatsApp number",
    category:"General",
    start:async(client,m,{command,prefix,text,args})=>{
        if (!args[0]) return m.reply(`Use command like: /stalk <incomplete-number>xx`)
        var inputnumber = args[0]
        if (!inputnumber.includes('x')) return m.reply('You did not added x \n\nUsage: /stalk 91810118783x')
