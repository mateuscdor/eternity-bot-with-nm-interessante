...
class QuickDB {
    ...
    constructor(options = {}) {
        // options.table ??= "json";
        options.table = options.table ? options.table : 'json';
        // options.filePath ??= "json.sqlite";
        options.filePath = options.filePath ? options.filePath : "json.sqlite";
        // options.driver ??= new SqliteDriver_1.SqliteDriver(options.filePath);
        options.driver = options.driver ? options.driver : new SqliteDriver_1.SqliteDriver(options.filePath) ;
